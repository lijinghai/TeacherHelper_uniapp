	...
	<view>
		...
		<view>
			<view class="cu-bar bg-white ">
				<view class="action sub-title">
					<text class="text-xl text-bold text-blue text-shadow">获取验证码</text>
					<text class="text-ABC text-blue">basic</text>
				</view>
				<!-- <view class="action" @click="go"><text class="text-lg text-grey text-shadow">下一步</text></view> -->
			</view>
		...
		<view>
			<!-- <view class="cu-bar bg-white margin-top-xs"> -->
				<view class="cu-bar bg-white">
				<view class="action sub-title">
					<text class="text-xl text-bold text-blue text-shadow">辨真伪</text>
					<text class="text-ABC text-blue">basic</text>
				</view>
			</view>
			...
			<view class="bg-white ">
				<view class="cu-steps">
					<view class="cu-item" :class="index>num?'':'text-blue'" v-for="(item,index) in numList2" :key="index">
						<text class="num" :class="index==2?'err':''" :data-index="index + 1"></text> {{item.name}}
					</view>
				</view>
			</view>
		...
		<!-- <view class="steps">
			<view class="out-box">
				<view class="self-box">
					<view :class="{ currentLineColor: currentStep >= 1 }"></view>
					<image :src="currentIcon(0) | ossImg" />
					<text :class="{ currentFontColor: currentStep >= 0 }">步骤1</text>
				</view>
				<view class="self-box">
					<view :class="{ currentLineColor: currentStep >= 2 }"></view>
					<image :src="currentIcon(1) | ossImg" />
					<text :class="{ currentFontColor: currentStep >= 1 }">步骤2</text>
				</view>
				<view class="self-box">
					<view :class="{ currentLineColor: currentStep >= 3 }"></view>
					<image :src="currentIcon(2) | ossImg" />
					<text :class="{ currentFontColor: currentStep >= 2 }">步骤3</text>
				</view>
				<view class="self-box">
					<image :src="currentIcon(3) | ossImg" />
					<text :class="{ currentFontColor: currentStep >= 3 }">步骤4</text>
				</view>
			</view>
		</view> -->
