<template>
	<view class="components-mimicry">
		<tn-custom>
			<block slot="left">
				<!-- #ifdef MP-WEIXIN -->
				<navigator class='action border-custom text-white' open-type="navigateBack" :delta="1"
					hover-class="none"
				...
				<navigator class='action border-custom' open-type="navigateBack" :delta="1" hover-class="none"
					style="width: 174rpx;height: 64rpx;margin-left: 20rpx">
					<text class='cuIcon-back'></text>
					<text class='cuIcon-homefill'></text>
				</navigator>
				<!-- #endif -->
		...
		<view class="padding-top-sl">
			<swiper class="card-swiper square-dot " circular="true" autoplay="true" interval="5000" duration="500"
				@change="bannerSwiper" indicator-color="#1b6cff" indicator-active-color="#1b6cff">
				<!-- #ifdef H5 -->
				<swiper-item v-for="(item, index) in (bannerimg)" :key="'banner' + index"
					:class="[ bannerCur==index ? 'cur shadow-blur' : '' ]">
					<view class='swiper-item bg-img shadow-blur' :style="'background-image:url(' + item.url + ')'">
					</view>
				</swiper-item>
				<!-- #endif -->
				<!-- #ifndef H5 -->
		...
		<view class="padding-sm">
			<view class="flex">
				<view class='flex-twice bg-white margin-xs bg-img shadow-blur radius-index solid mimicry'
					style="height:330rpx;background-image:url(https://s1.ax1x.com/2020/06/25/N03nBD.jpg)">
				</view>
				<view class='flex-sub radius margin-right-xs margin-left-sm'>
					<view class='flex-sub bg-white margin-top-xs bg-img shadow-blur radius-index solid mimicry'
						style="height:150rpx;background-image:url(https://s1.ax1x.com/2020/06/25/N03uHe.jpg)"></view>
					<view class='flex-sub bg-white margin-top bg-img shadow-blur radius-index solid mimicry'
						style="height:150rpx;background-image:url(https://s1.ax1x.com/2020/06/25/N03iN9.jpg)"></view>
				</view>
			</view>
		</view>
		...
		<view class="cu-card">
			<view class="cu-item bg-img mimicry"
				style="background-image:url(https://s1.ax1x.com/2020/06/25/N03MAH.jpg)">
		...
		<view class="cu-card" style="margin-top:-30rpx">
			<view class="cu-item bg-img mimicry"
				style="background-image:url(https://s1.ax1x.com/2020/06/25/N03mnO.jpg)">
				<view class="cardTitle">
					可我会像
				</view>
			</view>
			<view class="cu-item bg-img mimicry"
				style="background-image:url(https://s1.ax1x.com/2020/06/25/N03E1x.jpg)">
				<view class="cardTitle">
					可我会像
				</view>
			</view>
			<view class="cu-item bg-img mimicry"
				style="background-image:url(https://s1.ax1x.com/2020/06/25/N03Vc6.jpg)">
				<view class="cardTitle">
					可我会像
				</view>
			</view>
					...
					<view class="basis-df padding-xs" v-for="(item, index) in product" :key="'product' + index">
						<navigator url="/pages/product/product" hover-class="none">
							<view class="grid col-1 grid-square flex-sub">
								<view class="bg-img product-border shadow"
		...
		<view class="cu-bar tabbar foot tarbar-mimicry">
			...
			<view class="action navbar__item -blue">
				...
				<view class="cu-avatar sm round avatar -blue shadow">
					<text class="text-balck cuIcon-name text-sm"
						style="margin-bottom:-40px;font-size:20rpx;color:#303030">首页</text>
				</view>
			</view>
			...
			<view class="action navbar__item -orange">
				...
				<view class="cu-avatar sm round avatar -orange shadow"><text class="text-balck cuIcon-name text-sm"
						style="margin-bottom:-40px;font-size:20rpx;color:#303030">发现</text></view>
			</view>

			<view class="action navbar__item -yellow">
				<view class='cuIcon-cart text-bold navbar__icon icon'>
				</view>
				<view class="cu-avatar sm round avatar -yellow shadow"><text class="text-balck cuIcon-name text-sm"
						style="margin-bottom:-40px;font-size:20rpx;color:#303030">购物</text></view>
			</view>

			<view class="action navbar__item -purple">
				<view class='cuIcon-my text-bold navbar__icon icon'>
				</view>
				<view class="cu-avatar sm round avatar -purple shadow"><text class="text-balck cuIcon-name text-sm"
						style="margin-bottom:-40px;font-size:20rpx;color:#303030">你的</text></view>
			</view>
...
<style scoped>
	@import url("/pages/demo/minicry.css");
