			...
			<view class="tit">
				...
				<view class="cu-bar ">
					<view class="action sub-title">
						<text class="text-xl text-bold text-blue">欢迎您的加入</text>
						<text class="text-ABC text-blue">Join</text>
					</view>
				</view>
			</view>
			<view class="ul">
				...
				<uni-forms :rules="rules" ref="form" :value="user">
					<view class="li" :rules="rules" ref="form" :value="user">
						<uni-forms-item name="username">
							<input v-model="user.username" maxlength="11" placeholder-style="color: #AFAFB8" class="pr"
				...
				<view class="btn_login" :class="user.username.length == 11 && password ? 'btn2' : 'btn2'"
